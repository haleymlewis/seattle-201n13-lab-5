...
think it is finished, uncomment the call for the testSum() function below and 
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  var product3 = multiply(multiply(a, b) [0], c) [0];
  var messageSum = a + ' and ' + b + ' and ' + c + ' sum to ' + sum3 + '.';
  var messageMulti = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + product3 + '.';
  return[sum3, product3, messageSum, messageMulti];
}
...
function sumArray(sumArr) { //eslint-disable-line
    ...
    var message3 = testArray + ' was passed in as an array of numbers, and ' + sum3 + ' is their sum' + '.';
  return[sum3, message3];
}
...
function multiplyArray(multArr) { //eslint-disable-line
  var product5 = multiply(multiply(multiArr[0], multiArr[1])[0], multiArr[2])[0];
  var message5 = 'The numbers 2,3,4 have a product of 24.'
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  // var prodStretch = multiply(multiply(testDynamicArray[0], testDynamicArray[1])[0], testDynamicArray[2])[0];
  // var stretchMess = 'The numbers 1,2,3,4,5 have a product of 120.'
  // return [prodStretch, stretchMess];
